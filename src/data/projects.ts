...
export const PROJECTS = {
  'es': [
    ...
    },
    {
      ...
      description: 'Shortly es una aplicación web que te permite crear urls cortas personalizadas, donde puedes acortar las urls de los sitios web que quieras, y compartirlas con otras personas para acceder ellos fácilmente.',
      link: 'https://shortly-cesar.vercel.app/',
      image: '/projects/shortly.webp',
  ...
  'en': [
    ...
    },
    {
      ...
      description: 'Shortly is a web application that allows you to create custom short URLs, where you can shorten the URLs of any website and share them with others for easy access.',
      link: 'https://shortly-cesar.vercel.app/',
      image: '/projects/shortly.webp',
      github: 'https://github.com/chicho69-cesar/shortly',
      tags: [TAGS.REACT, TAGS.TAILWIND, TAGS.TYPESCRIPT, TAGS.POSTGRESQL, TAGS.SUPABASE],
      ...
      multiple_repos: [],
      full_description: 'Shortly is a web application that allows you to create custom short URLs, where you can shorten the URLs of any website and share them with others for easy access. <br/>This application is built with React and TypeScript, which I chose because it is my favorite front-end library and the one I have the most experience with. I love its component-based architecture, hooks, and the vast array of tools and libraries available to enhance the development experience. <br/>For data storage, I used Supabase, a comprehensive and easy-to-use SaaS tool that allows me to scale the application without issues. With Supabase, I implemented services ranging from user authentication for login and registration to relational database management with PostgreSQL and storage services for user profile photos and QR code images for each custom link. <br/>For styling and design, I utilized the Shadcn UI framework, which is a highly popular UI component framework with a wide range of components that accelerated the development of the website without needing to create styles from scratch, allowing me to create modern and attractive websites. <br/>The development of this project may seem simple, but it allowed me to implement knowledge about software design and architecture, as providing a solution to this type of problem requires good planning and design.',
    },
    {
      id: 'ink-chat',
